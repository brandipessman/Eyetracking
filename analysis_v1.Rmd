...
dt_predictions_features <- dt_predictions_features %>% 
  mutate(feature_yn = ifelse(photo == "Smaller Eyes"| photo == "Less Color" | photo == "No Web" | photo == "No Eggs" | photo == "No Fangs" | photo == "No Eating" | photo == "Not Hairy", "Without Feature", "With Feature"),
...
# fix fixation time, spider vs non-spider
...
# the rest of the layers edit the appearance of the graph
  ...
  ylab("Dwell Time (microseconds)") + # y axis label
...
```{r figure of gender differences}
